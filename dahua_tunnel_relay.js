...
var server = http.createServer(async function(req, res) {
  ...
  if (req.url === '/health') {
    ...
    return res.end(JSON.stringify({ status: 'ok', version: '2.0', features: ['status', 'tunnel', 'cgi' ] }));
  }
...
server.listen(PORT, function() {
  console.log('Dahua P2P Tunnel Relay v2.0 running on port ' + PORT);
